...
//	m_requests[REQ_RESOURCE] = MODE_BIT_BEGIN | MODE_BIT_FRAME | MODE_BIT_WORLD | MODE_BIT_ATTRIBUTE | MODE_BIT_TRANSFORM | MODE_BIT_SOLID | MODE_BIT_OBJECT | MODE_BIT_MOTION;
	...
	m_requests[REQ_ARCHIVE_BEGIN] = MODE_BIT_BEGIN | MODE_BIT_FRAME | MODE_BIT_WORLD | MODE_BIT_ATTRIBUTE | MODE_BIT_TRANSFORM | MODE_BIT_SOLID;
	m_requests[REQ_ARCHIVE_END] = MODE_BIT_OBJECT;
